...
<link type="text/css" rel="stylesheet" href="CSS/homeStyle.css">
        ...
        function f1()
        {
        	...
        	if(state=="ok")
        	{
        		...
        		nav2.innerHTML="<div id='login_c'>로그인 되었습니다.<br>닉네임 : "+name+"<br><br><button onclick='location.href=\"logout.jsp\"'>로그아웃</button><div id='menu'></div>";
        	}
...
<body onload="f1()">
        ...
        <div id="contents10">
            <iframe src="shooting.jsp" width="400" height="550"></iframe>
        </div>
